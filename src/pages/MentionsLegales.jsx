...
const MentionsLegales = () => {
    return (
        <div className="container mx-auto px-6 py-24 max-w-[800px]">
            <Helmet>
                <title>Mentions Légales | Benjamin - Entrepreneur Aligné</title>
                <meta name="description" content="Mentions légales du site entrepreneuraligne.fr - Éditeur, hébergement et propriété intellectuelle." />
                <link rel="canonical" href="https://entrepreneuraligne.fr/mentions-legales" />
            </Helmet>
